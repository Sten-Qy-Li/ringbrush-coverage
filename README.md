...
The default export settings are intentionally lightweight for long sessions: `2 FPS` at `640x360`. You can raise `--fps`, `--width`, and `--height` for smoother output, but render time will increase.
